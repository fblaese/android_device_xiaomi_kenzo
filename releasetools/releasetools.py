...
def FullOTA_InstallBegin_MMC(info):
  if OTA_VerifyEnd(info, info.input_version, info.input_zip):
    OTA_InstallBegin(info)
  return


def FullOTA_InstallBegin_MTD(info):
  print "warning radio-update: radio update for NAND devices not supported"
  return


def FullOTA_InstallBegin(info):
  FullOTA_InstallBegin_MMC(info)
  return

def IncrementalOTA_InstallBegin_MMC(info):
  OTA_InstallBegin(info)
  return


def IncrementalOTA_InstallBegin_MTD(info):
  print "warning radio-update: radio update for NAND devices not supported"
  return

def IncrementalOTA_InstallBegin(info):
  IncrementalOTA_InstallBegin_MMC(info)
  return
